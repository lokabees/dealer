<template>
  <div>
    <div>
      <label class="text-sm font-bold">IMAGE TITLE</label>
    </div>
    ...
    <div v-else>
      ...
      >
        ...
        />
        <div
          class="absolute top-0 flex h-full w-1/2 items-center z-1 bg-primary"
        >
    ...
    <div>
      <label class="text-danger text-sm font-bold">Error Upload</label>
    </div>
  </div>
</template>
